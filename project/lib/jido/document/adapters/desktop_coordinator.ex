defmodule Jido.Document.Adapters.DesktopCoordinator do
  @moduledoc """
  ...
  alias Jido.Document.Adapters.DesktopIPC
  ...
  @impl true
  def handle_info({:jido_document_signal, %Signal{} = signal}, state) do
