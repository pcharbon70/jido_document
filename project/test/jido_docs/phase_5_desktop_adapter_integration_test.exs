defmodule JidoDocs.Phase5DesktopAdapterIntegrationTest do
  use ExUnit.Case, async: true

  alias JidoDocs.Adapters.{DesktopCoordinator, DesktopIPC}
  ...
  setup do
    ...
    tmp_dir = Path.join(File.cwd!(), "tmp_jido_docs_phase5_desktop_" <> uniq)
