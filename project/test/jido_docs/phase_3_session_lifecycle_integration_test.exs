defmodule JidoDocs.Phase3SessionLifecycleIntegrationTest do
  ...
  setup do
    ...
    tmp_dir = Path.join(System.tmp_dir!(), "jido_docs_phase3_lifecycle_" <> session_id)
  ...
  test "agent restart supports graceful session close and relaunch", ctx do
    ...
    assert_receive {:jido_docs_signal, %Signal{type: :session_closed, session_id: ^session_id}},
                   500
