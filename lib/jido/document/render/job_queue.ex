defmodule Jido.Document.Render.JobQueue do
  @moduledoc """
  ...
  alias Jido.Document.{Error, Renderer}
  alias Jido.Document.Render.Metrics
  ...
  defp execute_job(job) do
    ...
    if is_pid(job.notify_pid) do
      send(
        job.notify_pid,
        {:jido_document_render_job, job.session_id, job.revision, result,
